const allLangs = {
    ...
    "aboutUs__description_additional": {
        "ua":
            "<br>" +
            "<b>Наша команда</b> це досвідчені фахівці, науковці, практики та експерти, які знають тонкощі своєї справи." +
            "<br><br>" +
            "<b>Наша мета</b> це зробити людей здоровішими, планету екологічною та безпечною, розробляючи та впроваджуючи " +
            "сучасні інноваційні технології, зберігаючи довкілля, покращуючи комфорт людей, їх безпеку, якість та рівень життя." +
            "<br><br>" +
            "<b>Політика компанії</b> – запропонувати споживачеві високотехнологічний корисний продукт, а інвестору – проект з високою " +
            "рентабельністю, масштабованістю та прикладною значущістю. Ми ті, хто покращить життя на Землі екологічно, системно і етично." +
            "<br><br>\n" +
            "<b>Наша місія</b> розвиток та поширення ідеології свідомого соціально-орієнтованого бізнесу в глобальній інтегрованій екосистемі світу.",
